#!/usr/bin/env python3
"""
sender.py — Scholarship Robot Email Sender
...
SMTP_RELAYS = [
    {
        ...
        "daily_limit":   300,
        "ssl":           False,
        "from_override": "scholarship@admission.lulllitcloud.com",
    },
    {
        "name":          "Mailjet",
...
def run(dry_run=False, limit=None):
    log.info("=== Scholarship Robot Sender starting ===")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scholarship Robot Email Sender")
    parser.add_argument(
